...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('jodent_logo'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Credit', 'for'], -40);
					#else
					createCoolText(['Credit', 'for'], -40);
					#end
				case 7:
					addMoreText('Jodent Dev Team', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nJodent Dev Team';
				case 8:
					deleteCoolText();
				...
				case 16:
					addMoreText('Jodent Takeover'); // credTextShit.text += '\nJodent Takeover';
